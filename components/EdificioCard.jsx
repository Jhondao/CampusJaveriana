...
export function EdificioCard({ edificio }) {
  return (
    <View
      ...
      <Image source={{ uri: edificio.image }} className="w-24 h-24 rounded-lg object-cover border border-gray-300" />
      <View>
        <Text className="text-lg font-bold text-gray-800">{edificio.title}</Text>
